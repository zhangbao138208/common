...
const TableNameWinCoinDepositRecordDelUser = "win_coin_deposit_record_del_user"

// WinCoinDepositRecordDelUser mapped from table <win_coin_deposit_record_del_user>
...
// TableName WinCoinDepositRecordDelUser's table name
func (*WinCoinDepositRecordDelUser) TableName() string {
	return TableNameWinCoinDepositRecordDelUser
}
