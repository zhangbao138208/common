...
const TableNameWinUserKycHi = "win_user_kyc_his"

// WinUserKycHi mapped from table <win_user_kyc_his>
type WinUserKycHi struct {
	...
	FirstName         string `gorm:"column:first_name;type:varchar(30);comment:first_name" json:"firstName"`      // first_name
	MiddleName        string `gorm:"column:middle_name;type:varchar(30);comment:middle_name" json:"middleName"`   // middle_name
	LastName          string `gorm:"column:last_name;type:varchar(255);comment:last_name" json:"lastName"`        // last_name
...
// TableName WinUserKycHi's table name
func (*WinUserKycHi) TableName() string {
	return TableNameWinUserKycHi
}
