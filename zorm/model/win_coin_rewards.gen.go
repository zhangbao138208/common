...
// WinCoinReward mapped from table <win_coin_rewards>
type WinCoinReward struct {
	...
	ReferID    int64           `gorm:"column:refer_id;type:int;comment:关联ID(活动表ID)" json:"referId"`                                  // 关联ID(活动表ID)
	...
	EndedAt    int64           `gorm:"column:ended_at;type:int;comment:活动结束时间" json:"endedAt"`                                       // 活动结束时间
	Info       string          `gorm:"column:info;type:longtext;comment:备注" json:"info"`                                             // 备注
	Status     int64           `gorm:"column:status;type:tinyint;not null;comment:状态:0-申请中 1-已满足 2-已派发3-已结束" json:"status"`          // 状态:0-申请中 1-已满足 2-已派发3-已结束
