...
const TableNameWinGameSlotCopy0526 = "win_game_slot_copy_0526"

// WinGameSlotCopy0526 mapped from table <win_game_slot_copy_0526>
type WinGameSlotCopy0526 struct {
	...
	TestI        int64  `gorm:"column:test_i;type:int" json:"testI"`
}

// TableName WinGameSlotCopy0526's table name
func (*WinGameSlotCopy0526) TableName() string {
	return TableNameWinGameSlotCopy0526
}
