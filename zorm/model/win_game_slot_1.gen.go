...
const TableNameWinGameSlot1 = "win_game_slot_1"

// WinGameSlot1 mapped from table <win_game_slot_1>
...
// TableName WinGameSlot1's table name
func (*WinGameSlot1) TableName() string {
	return TableNameWinGameSlot1
}
