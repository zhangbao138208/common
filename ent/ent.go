...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			common.Table:            common.ValidColumn,
			winbetslip.Table:        winbetslip.ValidColumn,
			winbetslipsdetail.Table: winbetslipsdetail.ValidColumn,
			wincoinlog.Table:        wincoinlog.ValidColumn,
			winconfig.Table:         winconfig.ValidColumn,
			windict.Table:           windict.ValidColumn,
			windictitem.Table:       windictitem.ValidColumn,
			wingamelist.Table:       wingamelist.ValidColumn,
			wingameslot.Table:       wingameslot.ValidColumn,
			winplatlist.Table:       winplatlist.ValidColumn,
			winuser.Table:           winuser.ValidColumn,
			winuserwallet.Table:     winuserwallet.ValidColumn,
		})
	})
